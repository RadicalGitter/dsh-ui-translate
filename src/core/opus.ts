...
export const OPUS_RUNTIME_VERSION = '0.2.0'
export const OPUS_ASSET_PREFIX = `/ui-translate/assets/v${OPUS_RUNTIME_VERSION}`
export const OPUS_WORKER_URL = `${OPUS_ASSET_PREFIX}/opus-worker.js`
export const OPUS_WASM_BASE_URL = `${OPUS_ASSET_PREFIX}/`
export const OPUS_MAX_TEXTS = 32
export const OPUS_MAX_TEXT_LENGTH = 160
